          ...
          <View style={styles['modal-box']}>
            ...
            <View style={styles.titleSub}>
              <Text style={styles['sub-text']}>
                You will need a minimum of 3 players
              </Text>
              <Text style={styles['sub-text']}>
                When all players are ready, each player will receive a type:
              </Text>
              ...
              <Text style={styles['sub-text']}>
                Mafias will see other Mafia players on their game screen
              </Text>
              <Text style={styles['sub-text']}>
                Civilians will not know each other
              </Text>
              <Text style={styles['sub-text']}>Hit ready again and play!</Text>
              <Text style={styles['sub-text']}>
                Once the time is up, you will need to vote out who you think the
                Mafia is, then go again until someone wins
              </Text>
              <Text style={styles['sub-text']}>
                Remember, Mafias are meant to lie...
              </Text>
            </View>
